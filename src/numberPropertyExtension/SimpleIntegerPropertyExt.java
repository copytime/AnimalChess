...
public class SimpleIntegerPropertyExt extends SimpleIntegerProperty {

    public SimpleIntegerPropertyExt(){
        super();
    }
    public SimpleIntegerPropertyExt(int var1) {
        super(var1);
    }

    public SimpleIntegerPropertyExt(Object var1, String var2) {
        super(var1,var2);
    }

    public SimpleIntegerPropertyExt(Object var1, String var2, int var3) {
